...
const SettingsPage = () => {
  ...
  useEffect(() => {
    if (selectedShift in shifts) {
      setSettings(shifts[selectedShift as keyof typeof shifts]);
    }
  }, [selectedShift, setSettings]);
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <Card>
        <CardHeader><CardTitle>Horário de Trabalho e Intervalo</CardTitle><CardDescription>Selecione um turno predefinido ou defina um horário personalizado.</CardDescription></CardHeader>
        <CardContent className="space-y-4">
          <RadioGroup value={selectedShift} onValueChange={setSelectedShift} className="mb-4">
